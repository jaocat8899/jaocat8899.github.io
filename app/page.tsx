      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            A lifestyle tool designed to help you reflect on your daily moods and activities through seamless TikTok integration.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Reflect on your daily emotions and track patterns over time
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Connect your social media activity with your mood insights
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your data stays private - we only use what's required by TikTok's API
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <footer className="bg-white border-t py-8 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-sm text-gray-500 mt-4">
            © 2024 MyMoodSync. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
